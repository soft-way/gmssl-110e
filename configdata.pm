...
our %config = (
  ...
  makedepprog => "gcc",
  minor => "1.0",
  openssl_algorithm_defines => [ "OPENSSL_NO_MD2", "OPENSSL_NO_RC5", "OPENSSL_NO_ZUC" ],
  openssl_api_defines => [  ],
  ...
  openssl_sys_defines => [ "OPENSSL_SYS_CYGWIN" ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "",
  options => "--debug --prefix=/usr/local/openssl-1.1.0e-sm no-asan no-crypto-mdebug no-crypto-mdebug-backtrace no-ec_nistp_64_gcc_128 no-egd no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic no-zuc",
  perl => "/usr/bin/perl",
  perlargv => [ "Cygwin-x86_64", "--debug", "--prefix=/usr/local/openssl-1.1.0e-sm" ],
  prefix => "/usr/local/openssl-1.1.0e-sm",
  processor => "",
  rc4_int => "unsigned int",
  sdirs => [ "objects", "md4", "md5", "sha", "mdc2", "hmac", "ripemd", "whrlpool", "poly1305", "blake2", "des", "aes", "rc2", "rc4", "idea", "bf", "cast", "camellia", "seed", "chacha", "modes", "bn", "ec", "rsa", "dsa", "dh", "dso", "engine", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "comp", "ocsp", "ui", "cms", "ts", "srp", "cmac", "ct", "async", "kdf", "sm3", "sms4", "kdf2", "ecies", "ffx", "sm2", "paillier", "cpk", "otp", "gmapi", "ec2", "bfibe", "bb1ibe", "sm9", "saf", "sdf", "skf", "sof", "serpent", "speck", "base58" ],
  shared_ldflag => "",
  shlib_major => "1",
  shlib_minor => "1",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cc => "gcc",
  cflags => "-DTERMIOS -DL_ENDIAN -Wall -g -O0",
    ...
    "sources" =>
        {
            ...
            "crypto/base58/base58.o" =>
                [
                    "crypto/base58/base58.c",
                ],
            "crypto/base58/base58_err.o" =>
                [
                    "crypto/base58/base58_err.c",
                ],
            "crypto/bb1ibe/bb1ibe_asn1.o" =>
                [
                    "crypto/bb1ibe/bb1ibe_asn1.c",
                ],
            "crypto/bb1ibe/bb1ibe_err.o" =>
                [
                    "crypto/bb1ibe/bb1ibe_err.c",
                ],
            "crypto/bb1ibe/bb1ibe_lib.o" =>
                [
            ...
            "crypto/bfibe/bfibe_asn1.o" =>
                [
                    "crypto/bfibe/bfibe_asn1.c",
                ],
            "crypto/bfibe/bfibe_err.o" =>
                [
                    "crypto/bfibe/bfibe_err.c",
                ],
            "crypto/bfibe/bfibe_lib.o" =>
                [
            ...
            "crypto/cpk/cpk_asn1.o" =>
                [
                    "crypto/cpk/cpk_asn1.c",
                ],
            "crypto/cpk/cpk_err.o" =>
                [
                    "crypto/cpk/cpk_err.c",
                ],
            "crypto/cpk/cpk_kap.o" =>
                [
                    "crypto/cpk/cpk_kap.c",
                ],
            "crypto/cpk/cpk_lib.o" =>
                [
                    "crypto/cpk/cpk_lib.c",
                ],
            "crypto/cpk/cpk_map.o" =>
                [
                    "crypto/cpk/cpk_map.c",
                ],
            "crypto/cpk/cpk_prn.o" =>
                [
            ...
            "crypto/ec2/bn_gfp2.o" =>
                [
                    "crypto/ec2/bn_gfp2.c",
                ],
            "crypto/ec2/bn_hash.o" =>
                [
                    "crypto/ec2/bn_hash.c",
                ],
            "crypto/ec2/bn_solinas.o" =>
                [
                    "crypto/ec2/bn_solinas.c",
                ],
            "crypto/ec2/ec_hash.o" =>
                [
                    "crypto/ec2/ec_hash.c",
                ],
            "crypto/ec2/ec_type1.o" =>
                [
                    "crypto/ec2/ec_type1.c",
                ],
            "crypto/ec2/fppoint.o" =>
                [
            ...
            "crypto/saf/saf_app.o" =>
                [
                    "crypto/saf/saf_app.c",
                ],
            "crypto/saf/saf_base64.o" =>
                [
                    "crypto/saf/saf_base64.c",
                ],
            "crypto/saf/saf_cert.o" =>
                [
            ...
            "crypto/saf/saf_enc.o" =>
                [
                    "crypto/saf/saf_enc.c",
                ],
            "crypto/saf/saf_err.o" =>
                [
                    "crypto/saf/saf_err.c",
                ],
            "crypto/saf/saf_errstr.o" =>
                [
                    "crypto/saf/saf_errstr.c",
                ],
            "crypto/saf/saf_hash.o" =>
                [
                    "crypto/saf/saf_hash.c",
                ],
            "crypto/saf/saf_keyhandle.o" =>
                [
                    "crypto/saf/saf_keyhandle.c",
                ],
            "crypto/saf/saf_lib.o" =>
                [
                    "crypto/saf/saf_lib.c",
                ],
            "crypto/saf/saf_mac.o" =>
                [
                    "crypto/saf/saf_mac.c",
                ],
            "crypto/saf/saf_pkcs7.o" =>
                [
                    "crypto/saf/saf_pkcs7.c",
                ],
            "crypto/saf/saf_rand.o" =>
                [
                    "crypto/saf/saf_rand.c",
                ],
            "crypto/saf/saf_rsa.o" =>
                [
                    "crypto/saf/saf_rsa.c",
                ],
            "crypto/saf/saf_sm2.o" =>
                [
                    "crypto/saf/saf_sm2.c",
                ],
            "crypto/saf/saf_symmkeyobj.o" =>
                [
            ...
            "crypto/sof/sof_err.o" =>
                [
                    "crypto/sof/sof_err.c",
                ],
            "crypto/sof/sof_lib.o" =>
                [
                    "crypto/sof/sof_lib.c",
                ],
            "crypto/speck/speck.o" =>
                [
